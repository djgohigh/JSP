...
<body>
	...
	<section>
		<div class="section">
			<input class="slide" type="radio" name="slide" id="slide04" checked> <input class="slide"
				type="radio" name="slide" id="slide05"> <input class="slide" type="radio"
				name="slide" id="slide06">
